...
| `createExchangeUserBank` | <ul><li>**userId**: The identifier of the user</li><li>**bankAccount**: Object with bank account info</li></ul> | Create bank account for user by admin |
