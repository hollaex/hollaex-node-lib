...
| `sendExchangeUserEmail` | <ul><li>**userId**:  The identifier of the user</li><li>**mail_type**: The mail type for the email payload</li><li>**data**: The content of the mail</li></ul> | Send email to exchange user account by admin |
