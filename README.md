...
| `createExchangeUser` | <ul><li>**email**: The mail address for the user</li<li>**password**: The password for the user</li><li>**opts.affiliation_code**: The referral code for the user</li></ul> | Create exchange user |
